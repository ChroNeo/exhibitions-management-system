...
export default function SurveyListPage() {
  ...
  const list =
    surveyData.state.status === "success" ? surveyData.state.data.units : [];
      ...
      <div className={styles.container}>
        <div className={styles.headerRow}>
          <div className={styles.header}>
            <h1 className={styles.title}>แบบประเมินงานนิทรรศการ</h1>
        ...
        {surveyData.state.status === "success" && (
          <section className={styles.surveySection}>
            <div className={styles.pinnedSurveyCard}>
              <button
                type="button"
